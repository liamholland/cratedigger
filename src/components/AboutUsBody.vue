...
<div class="container col-xxl-8 px-4 py-5" >
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        ...
        <img src="src/assets/img/CreateAccount.png" class="d-block mx-lg-auto img-fluid" width="300" height="300" loading="lazy">
      </div>
      <div class="col-lg-6">
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <img src="src/assets/img/Search.png" class="d-block mx-lg-auto img-fluid" width="700" height="500" loading="lazy">
...
<div class="container col-xxl-8 px-4 py-5" >
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div class="col-10 col-sm-8 col-lg-6">
        ...
        <img src="src/assets/img/likingAlbums.png" class="d-block mx-lg-auto img-fluid" width="300" height="300" loading="lazy">
      </div>
      <div class="col-lg-6">
  ...
  <div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        <img src="src/assets/img/Profile.png" class="d-block mx-lg-auto img-fluid" width="700" height="500" loading="lazy">
